...
<!-- Mirrored from www.ixtendo.com/themes/finesse-html/page-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jul 2015 23:24:14 GMT -->
<head>
	<!-- begin meta -->
	<meta charset="utf-8">
            ...
            <section id="navbar" class="clearfix">
                ...
                <nav id="nav">
                    <ul id="navlist" class="clearfix">
                        ...
                        <li class="current"><a href="about-us.html" data-rel="submenu2">Templates</a>
    	...
    	<div class="container">
            ...
            <div id="footer-bottom">
                ...
                <div class="one-half column-last">
                	<nav id="footer-nav">
                        <ul>
                            <li><a href="index-2.html">Home</a> &middot;</li>
